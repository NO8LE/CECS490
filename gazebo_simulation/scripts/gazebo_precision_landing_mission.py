...
Usage:
  python3 gazebo_precision_landing_mission.py [options]
...
# Try to import the ArUco detector class
try:
    from gazebo_aruco_detector import ArUcoDetector
    DETECTOR_AVAILABLE = True
except ImportError:
    DETECTOR_AVAILABLE = False
    print("Warning: gazebo_aruco_detector.py not found in Python path")
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Gazebo Precision Landing Mission Controller')
